...
mod tests {
    ...
    #[test]
    fn test_log_base_2() {
        assert_eq!(MortonLayout::log_base_2(5), 3);
        assert_eq!(MortonLayout::log_base_2(16), 5);
        assert_eq!(MortonLayout::log_base_2(77), 7);
        assert_eq!(MortonLayout::log_base_2(128), 8);
    }
